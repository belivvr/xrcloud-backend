...
export class Mig1687933860267 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "main"."scenes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "name" character varying NOT NULL, "infraSceneId" character varying NOT NULL, "infraProjectId" character varying NOT NULL, "thumbnailId" character varying NOT NULL, "projectId" character varying NOT NULL, "userId" character varying NOT NULL, CONSTRAINT "PK_071fd0f410cbb449feebafd46ac" PRIMARY KEY ("id"))`
        )
